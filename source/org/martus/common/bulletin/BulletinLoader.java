...
public class BulletinLoader
{
	...
	{
		FieldSpec[] standardFieldNames = StandardFieldSpecs.getDefaultTopSectionFieldSpecsAsArray();
		FieldSpec[] privateFieldNames = StandardFieldSpecs.getDefaultBottomSectionFieldSpecsAsArray();
