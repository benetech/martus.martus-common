...
public class UiBasicLocalization extends Localization
{
		...
		throws IOException 
	{
		...
		writer.writeln("#  2.  do NOT translate \"#N#\" or \"#M#\" (though move them as appropriate grammatically for the language to make \"N of M\" make sense for creating/restoring secret share).");  
		writer.writeln("#  3.  in field:VirtualKeyboardKeys, keep the english alphabet, but include any non-english characters at the end of the english alphabet/numbers/special characters (e.g. attach entire thai alphabet at the end of the line)");
		writer.writeln("#  4.  in field:SearchBulletinRules, make sure to translate the english \"and\" and \"or\" in the text to exactly match the keyword:and= and keyword:or= translations");
		writer.writeln("#  5.  in field:inputCustomFieldsentry, can translate tags into foreign characters (but without punctuation or spaces) -- since this may change in 2.0, hold off on this change until new custom field design is completed.");
		writer.writeln("#  6.  when there are file or directory names, do not translate them (e.g.  \"acctmap.txt\" and \"packets\" in field:confirmWarnMissingAccountMapFilecause=Warning: acctmap.txt file in your account's packets directory...");
		writer.writeln("#  7.  do not translate the words \"Martus\" or \"Benetech\"");
		writer.writeln("#  8.  change the line \"# In Martus, to choose a language, go to Options/Preferences.\" to be \"# In Martus, to choose a language, pick one of the drop-down box in the lower left-hand corner of the signin screen, or once you are logged in, go to Options/Preferences.");
		writer.writeln("#");
