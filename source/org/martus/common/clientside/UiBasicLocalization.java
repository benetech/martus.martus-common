...
public class UiBasicLocalization extends Localization
{
		...
		throws IOException 
	{
		...
		writer.writeln("#      since for some languages keyboards are not available to all users in those ");
		writer.writeln("#      alphabets. So please translate the following for the first sentence:   ");
		writer.writeln("#      \"When searching forbulletins you can add key words either in english or ");
		writer.writeln("#      the-language-you-are-translating (or/or-translated, and/and-translated) ");
		writer.writeln("#      between multiple search term words (e.g. prison or jail, prison and assault).");
